        ...
        extends RecordHandler
{
    ...
    private JdbcCredentialProvider getCredentialProvider(FederationRequest request)
    {
    ...
    public void readWithConstraint(BlockSpiller blockSpiller, ReadRecordsRequest readRecordsRequest, QueryStatusChecker queryStatusChecker)
    {
        ...
        try (Connection connection = this.jdbcConnectionFactory.getConnection(getCredentialProvider(readRecordsRequest))) {
